...
public class Desk { // TODO: rename the class to board?
  ...
  protected void createStartPosition() {
    ...
    int j = 0;
    for (int i = 0; i < (startPosition.length() - 1) / 4; i++) { // TODO: change '(startPosition.length()-1)/4' to 'allFigures.length'
      // TODO: this whole if looks overcomplicated
      // TODO: change it to the following
      // allFigures[i] = new Rook(startPosition.charAt(j),
      //                          startPosition.charAt(j + 2) - '1',
      //                          startPosition.charAt(j + 3) - '1',
      //                          image(startPosition.charAt(j + 1)),
      //                          type(startPosition.charAt(j + 1)));
      // and introduce two simple functions: image(char) and type(char)
